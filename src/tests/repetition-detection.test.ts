...
describe("truncateRepetitionLoop", () => {
    ...
    it("detects and truncates a long repeated phrase (exact match)", () => {
        const good = "Speaker 1: This is some real content about the meeting.\n\nSpeaker 2: Yes I agree with that point.";
        const repeated = " yeah, yeah, yeah. No, no, I know what I was just pulling your leg. Um,";
    ...
    it("detects repetition even when it starts mid-text", () => {
        const prefix = "Speaker 1: Let me explain the architecture.\n\nSpeaker 2: Sure, go ahead.\n\nSpeaker 1: So we have the frontend and backend.";
        const loop = " And then we repeat this process over and over again and keep on going until done.";
    ...
    it("handles the exact pattern from real bug #1 (exact short phrase x2869)", () => {
        ...
        const loopPhrase = " Um, yeah, yeah, yeah. No, no, I know what I was just pulling your leg.";
    ...
    it("handles real bug #2: near-identical multi-speaker block with tiny variations", () => {
        ...
        expect(result.text.length).toBeLessThan(good.length + blockVariantA.length + blockVariantB.length + 100);
    ...
    it("handles repetition that starts very early", () => {
        const good = "Speaker 1: Hi. Speaker 2: Hello there, how are you today my friend?";
        const loop = " This is a repeated sentence that goes on and on and on and keeps repeating endlessly.";
